...
namespace minecraft_kurwa {
    internal class Voxel {
        ...
        internal Voxel(Vector3 position, Color color, float transparency = 1.0f) {
            ...
            vertexBuffer = new VertexBuffer(Global.GRAPHICS_DEVICE, typeof(VertexPositionColor), VERTEX_COUNT, BufferUsage.None);
            indexBuffer = new IndexBuffer(Global.GRAPHICS_DEVICE, typeof(ushort), INDEX_COUNT, BufferUsage.None);
