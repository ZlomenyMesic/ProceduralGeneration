    ...
    internal static class ShrubGenerator {
        internal static void Generate() {
            ...
            for (ushort i = 0; i < maxCount; i++) {
                ...
                if (leaves != VoxelType.UNKNOWN) Shrub.Build(x, y, (ushort)(Global.HEIGHT_MAP[x, y] + 1), (ushort)Global.RANDOM.Next(Shrub.MIN_SHRUB_SIZE, Shrub.MAX_SHRUB_SIZE), (ushort)Global.RANDOM.Next(Shrub.MIN_SHRUB_SIZE, Shrub.MAX_SHRUB_SIZE), leaves);
            }
        }
    }
}
