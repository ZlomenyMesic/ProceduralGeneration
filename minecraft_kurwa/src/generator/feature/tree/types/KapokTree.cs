                ...
                for (sbyte y = -1; y <= 1; y++) {
                    ...
                    for (sbyte z = 0; z <= 1; z++) {
                        if (Global.RANDOM.Next(0, 3) == 0) {
                            ...
                            if (posX + x - 1 >= 0 && x == -1 && y == 0 && z == 0 && Global.RANDOM.Next(0, 2) == 0) Global.VOXEL_MAP[posX + x - 1, posY + y, posZ + z + height * 2 / 3] = woodType;
                            if (posX + x + 1 < Settings.WORLD_SIZE && x == 1 && y == 0 && z == 0 && Global.RANDOM.Next(0, 2) == 0) Global.VOXEL_MAP[posX + x + 1, posY + y, posZ + z + height * 2 / 3] = woodType;
                            if (posY + y - 1 >= 0 && x == 0 && y == -1 && z == 0 && Global.RANDOM.Next(0, 2) == 0) Global.VOXEL_MAP[posX + x, posY + y - 1, posZ + z + height * 2 / 3] = woodType;
                            if (posY + y + 1 < Settings.WORLD_SIZE && x == 0 && y == 1 && z == 0 && Global.RANDOM.Next(0, 2) == 0) Global.VOXEL_MAP[posX + x - 1, posY + y + 1, posZ + z + height * 2 / 3] = woodType;
                        }
                    }
                }
            }
