        ...
        internal static void Generate() {
            ...
            for (ushort i = 0; i < maxCount; i++) {
                ...
                if (biome == 32 || biome == 42) {
                    trees[treeCount++] = random.Next(0, 50) switch {
                        0 =>                                new BasicDeciduousTree(x, y, (ushort)(Global.HEIGHT_MAP[x, y] + 1), (byte)random.Next(Dimensions.CHERRY_MIN_HEIGHT, Dimensions.CHERRY_MAX_HEIGHT),  VoxelType.CHERRY_LEAVES, VoxelType.CHERRY_WOOD),
                        1 or 2 or 3 =>                      new SpruceTree(x, y, (ushort)(Global.HEIGHT_MAP[x, y] + 1),         (byte)random.Next(Dimensions.SPRUCE_MIN_HEIGHT, Dimensions.SPRUCE_MAX_HEIGHT)),
                        4 or 5 or 6 or 7 =>                 new BasicDeciduousTree(x, y, (ushort)(Global.HEIGHT_MAP[x, y] + 1), (byte)random.Next(Dimensions.BEECH_MIN_HEIGHT,  Dimensions.BEECH_MAX_HEIGHT),   VoxelType.BEECH_LEAVES, VoxelType.BEECH_WOOD),
                        8 or 9 or 10 or 11 =>               new PoplarTree(x, y, (ushort)(Global.HEIGHT_MAP[x, y] + 1),         (byte)random.Next(Dimensions.POPLAR_MIN_HEIGHT, Dimensions.POPLAR_MAX_HEIGHT)),
                        12 or 13 or 14 or 15 or 16 or 17 => new BasicDeciduousTree(x, y, (ushort)(Global.HEIGHT_MAP[x, y] + 1), (byte)random.Next(Dimensions.MAPLE_MIN_HEIGHT,  Dimensions.MAPLE_MAX_HEIGHT),   VoxelType.MAPLE_LEAVES, VoxelType.MAPLE_WOOD),
                        _ =>                                new BasicDeciduousTree(x, y, (ushort)(Global.HEIGHT_MAP[x, y] + 1), (byte)random.Next(Dimensions.OAK_MIN_HEIGHT,    Dimensions.OAK_MAX_HEIGHT),     VoxelType.OAK_LEAVES, VoxelType.OAK_WOOD),
                    };
                }
                else if (biome == 11) {
